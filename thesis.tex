...
Di conseguenza, la mAP50 è pari a 0.539, mentre la mAP50-95 risulta essere 0.385. Si ha quindi un calo di prestazioni rispettivamente di 0.434 e 0.418 rispetto all'\hyperref[sec:esperimento_ds_1_1]{Esperimento 1}. Questo calo è significativo e conferma l'impatto del domain shift, ma potrebbe essere mitigato aumentando la varietà degli ambienti di addestramento.
