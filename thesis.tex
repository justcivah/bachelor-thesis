...
Per il segmentatore si è scelto un modello YOLO, mentre per l'encoder-decoder abbiamo optato per una semplice UNet. Il motivo della scelta di questi particolari modelli è descritta nelle prossime sezioni. Uno schema riassuntivo dell'architettura UNet - YOLO è illustrato nella \hyperref[fig:architettura-unet-yolo]{Figura \ref{fig:architettura-unet-yolo}}.
