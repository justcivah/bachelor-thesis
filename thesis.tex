...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width=0.38\textwidth]{images/domain-shift/sim-to-sim/1/original-1.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.38\textwidth]{images/domain-shift/sim-to-sim/1/prediction-1.jpg}}
	\hspace{0.01\textwidth}
...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width=0.38\textwidth]{images/domain-shift/real-to-real/1/original-1.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.38\textwidth]{images/domain-shift/real-to-real/1/prediction-1.jpg}}
	\hspace{0.01\textwidth}
