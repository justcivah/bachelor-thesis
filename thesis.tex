...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width=0.42\textwidth]{images/domain-shift/real-to-real/1/original-1.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.42\textwidth]{images/domain-shift/real-to-real/1/prediction-1.jpg}}
	\hspace{0.01\textwidth}
...
\begin{figure}[h!]
	...
	\label{fig:real-to-real-prediction-2}
\end{figure}

Considerando i dati di validazione, questo modello ottiene una mAP50 di 0.459 e una mAP50-95 di 0.279. Questi valori sono molto vicini a quelli ottenuti in fase di training, con una differenza di 0.048 nel primo caso e 0.047 nel secondo. Questo risultato indica un domain shift di un ordine di grandezza inferiore rispetto a quanto osservato nell'\hyperref[sec:esperimento_ds_2_2]{Esperimento 2} della sezione real-to-real e nell'\hyperref[sec:esperimento_ds_1_2]{Esperimento 2} di quella sim-to-sim. Questo dimostra che, per una generalizzazione efficace, è necessario disporre di dati eterogenei provenienti da un ampio numero di scene diverse tra loro. Inoltre, anche un numero limitato di immagini per ambiente è sufficiente a garantire una buona capacità di generalizzazione.
