...
Nel seguente capitolo viene illustrato lo scopo della tesi, analizzando gli strumenti utilizzati e motivandone le scelte. Verranno inoltre spiegati i processi di creazione e addestramento dei modelli, presentando frammenti di codice che ne esemplificano l'implementazione.

\section{Scopo dell'elaborato}
\label{chap:scopo_dell_elaborato}
...
\label{chap:preparazione_dei_dataset}
...
\label{chap:formato_dataset_yolo11}
...
\label{chap:addestramento_dei modelli}
