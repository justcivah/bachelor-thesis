...
La scelta del segmentatore semantico è stata una delle decisioni più importanti dell'intero progetto, in quanto tutto il lavoro successivo si sarebbe basato su questo modello. Cambiarlo in corsa avrebbe voluto dire rincominciare tutto il lavoro da capo.

Diversi modelli hanno architetture differenti, e sono progettati per scopi diversi. Quelli inizialmente considerati sono stati YOLO, DETR e Detectron2.

\textbf{YOLO}
YOLO~\cite{JIANG20221066}, acronimo di You Only Look Once, è un modello 
