...
Per eseguire gli script di conversione e addestramento è stato creato un ambiente virtuale utilizzando Anaconda~\cite{anaconda}, nel quale sono stati installati i seguenti pacchetti:
...
Si consiglia di installare tutte le dipendenze contemporaneamente, così da permettere ad Anaconda di risolvere eventuali conflitti in maniera automatica. Una volta creato un nuovo ambiente con Python 3.12, basta eseguire il seguente comando per installare tutti i pacchetti necessari:
