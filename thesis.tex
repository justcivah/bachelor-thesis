...
\title{Domain shift in simulazione e realtà nella segmentazione semantica applicata a compiti di visione robotica}
...
Ognuna di queste directory contiene al suo interno altre sottodirectory, ognuna con una tipoligia diversa di dati:
