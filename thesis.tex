...
\begin{figure}[t]
	\centering
	\subfloat[]{\includegraphics[width=0.38\textwidth]{images/simulated-image.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.38\textwidth]{images/real-image.jpg}}
...
\begin{figure}[t]
	\centering
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/penguin-original.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/penguin-blur.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/penguin-black-and-white.jpg}}
	\hspace{0.01\textwidth}
	\\	
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/penguin-low-exposure.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/penguin-flip.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/penguin-rotation.jpg}}
...
\begin{figure}[t]
	\centering
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/original-segmentation.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/semantic-segmentation.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.23\textwidth]{images/instance-segmentation.jpg}}
...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width=0.42\textwidth]{images/fog-robotics/real-to-real/8/input.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.42\textwidth]{images/fog-robotics/real-to-real/8/output.jpg}}
