...
In questo capitolo sono descritti gli esperimenti condotti per approfondire il problema del domain shift, analizzandolo in ambienti simulati, reali e nel passaggio tra simulato e reale. Sarà poi discussa l'efficacia dell'architettura UNet-YOLO in vari contesti e verranno illustrati i risultati finali con le relative considerazioni.
...
Per eseguire gli script di conversione e addestramento è stato creato un ambiente virtuale utilizzando Anaconda~\cite{anaconda}, sul quale sono stati installati i seguenti pacchetti:
