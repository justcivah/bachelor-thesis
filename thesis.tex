...
È quindi necessario convertire i dati di segmentazione semantica di iGibson in un formato valido per YOLO. Poichè non esiste un modo automatico per fare questa operazione, ho dovuto creare una serie di script Python. I principali sono:
...
\begin{itemize}
	...
	\item \textbf{create\_validation\_data.py}:
\end{itemize}
