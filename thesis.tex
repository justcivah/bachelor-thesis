...
Come ultimo esperimento di questo elaborato, andiamo ad analizzare se l'architettura UNet-YOLO riesce a proiettare i dati provenienti dal mondo reale sul dominio del segmentatore semantico, addestrato con dati simulati. In questo caso vogliamo che la UNet trasforma le feature delle immagini reali nelle corrispondenti feature presenti negli ambienti simulati. Per fare questo viene utilizzato il modello YOLO11 ottenuto nell'\hyperref[sec:esperimento_3]{Esperimento 3} e, senza congelare i suoi pesi, viene effettuato fine-tuning con le stesse 20 scene utilizzate in precedenza. A causa delle limitate risorse hardware, anche per questo esperimento si è costretti ad impostare ad 1 la dimensione del batch, lasciando tutti gli altri parametri inalterati rispetto agli esperimenti precedenti. L'addestramento è stato effettuato sul PC1 e, dopo circa 5 ore di addestramento, sono state prodotte le metriche riportate nella \hyperref[fig:training-9]{Figura \ref{fig:training-9}}
