...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width=0.35\textwidth]{images/domain-shift/sim-to-sim/1/original-1.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.35\textwidth]{images/domain-shift/sim-to-sim/1/prediction-1.jpg}}
	\hspace{0.01\textwidth}
...
%COMMENTO AL RISULTATO OTTENUTO
...
Il secondo caso di studio riguarda l'analisi del domain shift in ambienti reali. Vengono addestrati modelli utilizzando 10, 50 e 395 diverse scene provenienti dal dataset ScanNet. Nel primo caso vengono mostrate le metriche di addestramento con informazioni relative alla validazione, mentre negli ultimi due casi vengono mostrate solo le più interessanti metriche di training con le loss di testing. Per tutti questi esperimenti è stato utilizzato il PC1.

\subsubsection{Esperimento 1}
\label{sec:esperimento_ds_2_1}

Per il primo esperimento sono state utilizzate 8956 immagini di training provenienti da 10 scene, e 1580 immagini per la validazione provenienti dagli stessi 10 ambienti. Il modello è stato addestrato per 60 epoche, con batch di dimensione 12, risoluzione delle immagini a 640 pixel, e parametro \textit{rect} impostato a \textit{True}. Essendo le immagini di scannet rettangolari, con quest'ultima impostazione si evita di tagliare le immagini in un formato quadrato, e si indica che il lato più lungo deve essere di 640 pixel. Dopo 4 ore e 30 minuti di addestramento, sono state generate le metriche riportate nella \hyperref[fig:real-to-real-training-1]{Figura \ref{fig:real-to-real-training-1}}.
...
\begin{figure}[h!]
	...
	\caption{Metriche di addestramento nel caso di ambienti reali, con dati di validazione provenienti dagli stessi ambienti di training.}
...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width=0.35\textwidth]{images/domain-shift/real-to-real/1/original-1.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.35\textwidth]{images/domain-shift/real-to-real/1/prediction-1.jpg}}
	\hspace{0.01\textwidth}
	\caption{Output del modello (b) considerando dati provenienti dalle 10 scene ScanNet (a).}
...
L'ultimo caso di studio riguarda
