...
\begin{figure}[h!]
	\centering
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/1/train-loss}}
	\hspace{0.01\textwidth}
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/1/validation-loss}}
	\hspace{0.01\textwidth}
	\\
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/1/map50}}
	\hspace{0.01\textwidth}
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/1/map50-95}}
...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width=0.42\textwidth]{images/fog-robotics/real-to-real/1/input.jpg}}
	\hspace{0.01\textwidth}
	\subfloat[]{\includegraphics[width=0.42\textwidth]{images/fog-robotics/real-to-real/1/output.jpg}}
...
Nel seguente esperimento metteremo invece alla prova le performance della stessa architettura riducendo il numero di pesi della UNet. Decrementiamo i 31 milioni di parametri di una UNet fino a lasciarne circa 7.7 milioni. In questo modo, possiamo vedere se può trovare un buon compromesso tra performance e risorse necessarie dai server fog per eseguire questa architettura. Gli altri parametri e dataset restano invariati rispetto all'esperimento precedente. I risultati dell'addestramento sono riportate nella \hyperref[fig:training-7]{Figura \ref{fig:training-7}}

\begin{figure}[h!]
	\centering
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/2/train-loss}}
	\hspace{0.01\textwidth}
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/2/validation-loss}}
	\hspace{0.01\textwidth}
	\\
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/2/map50}}
	\hspace{0.01\textwidth}
	{\includegraphics[width=0.48\textwidth]{images/fog-robotics/real-to-real/2/map50-95}}
	\caption{Metriche di addestramento del modello distribuito, utilizzando un segmentatore preaddestrato con 395 scene. Fine-tuning e validazione effettuati con dati provenienti da altre 20 scene. È stata utilizzata una UNet con solo 7.7 milioni di parametri.}
