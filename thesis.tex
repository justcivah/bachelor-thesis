...
L'obiettivo di questo elaborato è studiare il fenomeno del domain shift, in particolare analizzare come le performance di un modello degradano nei tre casi precedentemente descritti: sim-to-sim (nel caso di ambienti in uno stesso simulatore), real-to-real e sim-to-real. Viene inoltre proposta un'architettura alternativa basata su una seconda rete neurale di tipo encoder-decoder, che sarà utilizzata per condurre ulteriori esperimenti e considerazioni sul domain shift.
