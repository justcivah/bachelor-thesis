...
%ulteriore introduzione nella quale si ripete e approfondisce quanto detto nello scopo dell'elaborato. Diciamo che per il compito di analisi del domain shift in sim-sim, real-real e sim-real è necessario un solo modello, mentre che per la stessa analisi in un sistema distribuito risulta necessario realizzare un nuovo modello, che alla fine non è altro che un merging di due modelli già esistenti: un segmentatore semantico e un encoder-decoder.%
